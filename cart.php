                ...
                ?>
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div class="cart-prod-img mr-2 mr-sm-2">
                            <img src="<?php echo validate_image($img) ?>" loading="lazy" class="" alt="">
                            <img src="<?php echo validate_image($img) ?>" loading="lazy" class="filtered-image" alt="">
                            </div>
                            <div>
                                <p class="mb-1 mb-sm-1"><?php echo $row['title'] ?></p>
                                
                                <p class="mb-1 mb-sm-1"><small><b>Price:</b> <span class="price"><?php echo number_format($row['price']) ?></span></small>
                                <br>
                                <small><span class="desc"><?php echo $row['idesc'] ?></span></small>
                                </p>
                                <div>
