...
<section class="py-5">
    <div class="container">
        <div class="card rounded-0">
            ...
            <h3 class="text-center"><b>Submit Reservation</b></h3>
                ...
                <div class="row row-col-1 justify-content-center">
                    <div class="col-6">
                        ...
                        <div class="form-group col address-holder">
                            <label for="" class="control-label">Event Venue</label>
                        ...
                        <div class="col my-3">
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-dark">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success:function(resp){
                if(!!resp.status && resp.status == 'success'){
                    alert_toast("Reservation Successfully placed.","success")
                    setTimeout(function(){
                        location.replace('./')
                    },2000)
                }else{
